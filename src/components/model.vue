      ...
      <form id="editStudentForm">
        ...
        <div class="sex">
          ...
          <input
            ...
            value="0"
            ref="sex"
            :checked="editUser.sex == 0"
            @change="uptadeUser('sex, 0')"
          >
          <span>男</span>
          <input
            type="radio"
            name="sex"
            value="1"
            :checked="editUser.sex == 1"
            @change="uptadeUser('sex, 1')"
          >
          <span>女</span>
        </div>
        <div>
          ...
          <input
            ...
            ref="sNo"
            :value="editUser.sNo"
            @input="updateUser('sNo', $event.target.value)"
          >
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            @input="updateUser('birth', $event.target.value)"
          >
        </div>
        <div>
        ...
        <div>
          ...
          <input
            ...
            @input="updateUser('address', $event.target.value)"
          >
        </div>
        <div>
          <label for></label>
